...
Create a versioned `validation_id` linked to strategy code/config, data references, cost model, test periods, metrics, limitations, approvals, and next review date. Send it to `$trade-journal-review`.
