...
Keep quantity null until `skills/portfolio-risk-manager/SKILL.md` receives sufficient sizing
...
Send `LONG` or `SHORT` plus the proposed ticket mapping to `skills/portfolio-risk-manager/SKILL.md`. Send every outcome to `skills/trade-journal-review/SKILL.md` as a proposed manual plan. Never call a broker or claim the user entered.
