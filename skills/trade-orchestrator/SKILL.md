...
For the first open-ended scan of a session, read and apply `skills/market-data-acquisition/SKILL.md`
...
For an XTB workflow, require the acquisition pack at `skills/market-data-acquisition/SKILL.md` to apply its verified
...
Read and apply `skills/market-data-acquisition/SKILL.md`. Accept delayed data when the provider timestamp/delay is known or the local observation time is recorded.
...
Read and apply `skills/trade-decision-guardrails/SKILL.md`.
...
A validated strategy may be used when available. For a one-off discretionary analysis, do not require `skills/trade-strategy-specification/SKILL.md` or `skills/strategy-validation/SKILL.md`; label the framework `UNVALIDATED_DISCRETIONARY`.

### 4. Build the Manual Risk Plan

Read and apply `skills/portfolio-risk-manager/SKILL.md`.
...
Read and apply `skills/order-execution-controls/SKILL.md` only after
...
Read and apply `skills/trade-journal-review/SKILL.md` for a material acquisition baseline, candidate
