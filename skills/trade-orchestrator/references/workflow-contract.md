...
1. `skills/market-data-acquisition/SKILL.md`
2. `skills/trade-decision-guardrails/SKILL.md`
3. `skills/portfolio-risk-manager/SKILL.md`
4. `skills/trade-journal-review/SKILL.md`

Optional:

- `skills/trade-strategy-specification/SKILL.md` and `skills/strategy-validation/SKILL.md` for repeatable systematic strategies;
- `skills/order-execution-controls/SKILL.md` for local arithmetic and manual-ticket validation only;
- `skills/broker-account-snapshot/SKILL.md` only when the user explicitly requests optional account-aware sizing.
