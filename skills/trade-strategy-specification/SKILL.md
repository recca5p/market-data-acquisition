...
Every public decision field must map to `skills/market-data-acquisition/SKILL.md`. Treat `skills/broker-account-snapshot/SKILL.md` as an optional source only when the user explicitly wants account-aware sizing.
...
Keep position sizing as an interface to `skills/portfolio-risk-manager/SKILL.md`; do not embed martingale, averaging down, or unbounded risk.
...
Send the exact artifact to `skills/strategy-validation/SKILL.md`. Any later change to logic, data, parameters, universe, basis, costs, or execution produces a new version.
...
8. handoff to `skills/strategy-validation/SKILL.md`.
