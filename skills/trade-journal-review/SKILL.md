...
Label small samples and unvalidated discretionary plans clearly. Route systematic drift back to `skills/strategy-validation/SKILL.md` when that optional workflow is in use.
