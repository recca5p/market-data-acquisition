...
Send the manual plan to `skills/trade-orchestrator/SKILL.md` and `skills/trade-journal-review/SKILL.md`. Do not send anything to a broker and do not describe a suggested quantity as approved.
